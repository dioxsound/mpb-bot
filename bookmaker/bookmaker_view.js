class BookmakerView {
    ...
    static getBookmakerOptionsMessage(position, casinoData) {
        ...
        if (!casinoData) return (
            ...
            `\n  –   SPARTAK: <code>доп. коэфф.: 1x, комиссия: 5%</code>` +
            `\n  –   BETBANG: <code>доп. коэфф.: 1.25x, комиссия: 15%</code>` +
            `\n  –   LEVONRU: <code>доп. коэфф.: 1x, комиссия: 5%</code>`
        );
        ...
        return (
            ...
            `      <code>100XBET</code>, <code>SPARTAK</code>, <code>BETBANG</code>, <code>LEVONRU</code>`
        );
    }
